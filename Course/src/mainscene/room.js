...
export default class RoomScene extends Laya.Sprite{
    ...
    */
     ...
     * 添加声音icon
     */  
    creatIcon(HasAutoPrompt,url,id){  
        this.audioItem = new audioIcon(null,url,null,id);
    ...
    */
    btnEvent(){ 
        ...
        this.btnLeft.on(Laya.Event.CLICK,this,()=>{        
            ...
            if(!GM.IsToken){
                messageCenter.emit('newpage',{page:i,senderId:GM.senderId});
            }
        ...
        this.bottom.resetBtn.on(Laya.Event.CLICK,this,()=>{
             ...
             if(!GM.IsToken){
                messageCenter.emit('newpage',{page:this.pageNum,senderId:GM.senderId});
             }
